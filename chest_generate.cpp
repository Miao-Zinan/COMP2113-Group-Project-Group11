...
)
{
    ...
    double ratio;
    switch (difficulty) {
        case 1: ratio = 0.015; break;
        case 2: ratio = 0.015; break;
        case 3: ratio = 0.0225; break;
        default: ratio = 0.02; break;
    }
    int chestCount = static_cast<int>(candidates.size() * ratio);
    if (difficulty == 1 && chestCount < 1) {
        chestCount = 1;
    }
